const navbar = ()=>{
    ...
    <div id="leftNav">
        ...
        <div id="searchNavbar">
            ...
            <input type="text" id="InputNavbar" placeholder="Try Saree,Kurti or By Product Code"></div>
    </div>
    ...
    <div id="RightNav">
        <ul>
            ...
            <a href="#"> <img src="https://meesho.com/_next/static/images/playstore-a7dfd2afcd42f96d491912cbec2d6fa2.png"
            alt="android"> </a>
            <a href="#">  <img src="https://meesho.com/_next/static/images/appstore-a689c2ac38f3ed1ab7e7b39e98aaf15a.png" alt="ios"></img> </a>
                 </div>
            </div>
         </a></li>
